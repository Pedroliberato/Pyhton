...
if (escolhaPlayer == 1):
    ...
    if(cabanaIluminada == 1):
        ...
        if(esqueleto == 1):
            ...
            sleep(5)
            print('Sem saber oque fazer o goblin te ataca com uma faca, por sorte o seu esqueleto te proteje e o ataca logo em seguida')
            sleep(5)
            print('Você decide pular a janela quando ouve vozes vindo de fora da cabana')
            sleep(5)
        ...
        sleep(5)
        print('porem não muitos passos depois vocês acaba caindo em uma armadilha e ficam suspensos em uma arvore')
        sleep(5)
        print('Quando você percebe foi rodeado por goblins')
        sleep(5)
        print('Você está correndo perigo mas percebe que o antebraço do seu servo é pontudo e pode cortar as cordas')
        ...
        if(antebraçoEsqueleto == 1):
            ...
            sleep(5)
            print('... Você morreu')
            print('Talvez tenha sido o preço a ser pago pela vida de seu servo. Tente Novamente')
        elif(antebraçoEsqueleto == 2):
            print('Se recusando a sacrificar um aliado você começa a roer com os dentes as cordas que o prendia a arvore.')
            sleep(5)
    ...
    if(cabanaIluminada == 1):
        ...
        if(sombraMisteriosa == 1):
            ...
            sleep(5)
            print('... Você morreu')
            print('Não entre em lugares desconhecidos sem poder se defender. Tente Novamente')
    elif(cabanaIluminada == 2):
